 ...
 */
public class FaceRecordFragment extends Fragment {
    ...
    final String TAG = "frankiecamera";
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.e(TAG, "cid is:" + cameraId + "mPreviewSize width:" + mPreviewSize.getWidth());
                //获取相机支持的最大拍照尺寸
                ...
                setupImageReader();
                mCameraId = cameraId;
                Log.e(TAG, "zzz camera id is:" + cameraId);
                break;
            }
    ...
    private void openCamera() {
        ...
        try {
            if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                Log.e(TAG, "permission error return");
                return;
            }
            Log.e(TAG, "camera id is:" + mCameraId);
    ...
    private CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice camera) {
            if(camera == null) Log.e(TAG, "camera is null");
            else Log.e(TAG, "camera is not null");
    ...
    private void startPreview() {
        ...
        if(mPreviewSize == null) Log.e(TAG, "mPreviewSize is null");
        else Log.e(TAG, "mPreviewSize is not null");
        mSurfaceTexture.setDefaultBufferSize(mPreviewSize.getWidth(), mPreviewSize.getHeight());
        Surface previewSurface = new Surface(mSurfaceTexture);
        try {
            if(mCameraDevice == null) Log.e(TAG, "mCameraDevice is null");
            else Log.e(TAG, "mCameraDevice is not null");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_face_record, container, false);
    }
